...
<head>
    ...
    <script type="text/JavaScript" src="js/checkLoginIs.js"></script>
...
<body>
    <table>
        ...
        <tr><td colspan="2" align="right"><input type="button" name="enter" value="Войти" onclick="checkLoginIs()" class="demo"></td></tr>
